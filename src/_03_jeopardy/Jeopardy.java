...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel = createHeader("Fruit Fact");
		...
		fifthButton = createButton("$10000");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == secondButton){
			// Call the askQuestion() method
			askQuestion("Where is a banana in the food pyramid", "fruit", 400);
			secondButton.setText(null);
		}
		if(e.getSource() == thirdButton){
			// Call the askQuestion() method
			askQuestion("True or False: A banana is a berry", "True", 600);
			thirdButton.setText(null);
		}
		if(e.getSource() == fourthButton){
			// Call the askQuestion() method
			askQuestion("True or False: A tomato is a vegatable", "False", 800);
			fourthButton.setText(null);
		}
		if(e.getSource() == fifthButton){
			// Call the askQuestion() method
			askQuestion("What color is an orange", "tangerine", 10000);
